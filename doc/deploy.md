...
- Taobao 已补齐 live 协议骨架、签名 envelope、请求格式切换、可配置 method/path，以及重试/超时/trace 基础能力
...
- `JUYU_ALIBABA_REQUEST_FORMAT`
- `JUYU_ALIBABA_AUTH_PLACEMENT`
- `JUYU_ALIBABA_INCLUDE_APP_KEY`
- `JUYU_ALIBABA_INCLUDE_VERSION`
- `JUYU_ALIBABA_PUBLISH_METHOD`
- `JUYU_ALIBABA_UPDATE_METHOD`
- `JUYU_ALIBABA_ON_SHELF_METHOD`
- `JUYU_ALIBABA_OFF_SHELF_METHOD`
- `JUYU_ALIBABA_PUBLISH_PATH`
- `JUYU_ALIBABA_UPDATE_PATH`
- `JUYU_ALIBABA_ON_SHELF_PATH`
- `JUYU_ALIBABA_OFF_SHELF_PATH`
- `JUYU_ALIBABA_TIMEOUT_MS`
- `JUYU_ALIBABA_RETRY_ATTEMPTS`
- `JUYU_ALIBABA_RETRY_DELAY_MS`
- `JUYU_TAOBAO_APP_KEY`
- `JUYU_TAOBAO_SECRET`
...
- `JUYU_TAOBAO_TIMEOUT_MS`
- `JUYU_TAOBAO_RETRY_ATTEMPTS`
- `JUYU_TAOBAO_RETRY_DELAY_MS`
